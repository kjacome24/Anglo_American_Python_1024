...
class Arma:
    def __init__(self, nombre, dano):
        # Inicializa los atributos de la clase Arma
        self.nombre = nombre  # Nombre del arma
        self.dano = dano  # Daño que el arma puede causar
...
class SuperHeroe:
    ...
    def __init__(self, nombre, poder, nivel_fuerza=50):
        ...
        # Asociación con un objeto de la clase Arma
        self.arma = Arma("puños", 30)  # Inicialmente, el superhéroe tiene el arma "puños" con 30 de daño
